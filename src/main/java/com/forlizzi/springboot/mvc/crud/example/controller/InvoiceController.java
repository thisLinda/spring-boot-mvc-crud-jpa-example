package com.forlizzi.springboot.mvc.crud.example.controller;

// SIX(or SEVEN, they are dependent upon one another): the flow of data access is complete, controller class will
// handle incoming requests from the browser.
// Annotate with @Controller to inform Spring Container that this is the controller, it will have handler methods to
// serve the requests for performing crud operations
// connects to service with auto-wiring of the service interface
// each handler method returns a UI page
...
import com.forlizzi.springboot.mvc.crud.example.service.IInvoiceService;
